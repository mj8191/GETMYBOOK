...
import OrderStatus from './src/components/agent/OrderStatus';
import List from './src/components/agent/List';
...
import ItemDetail from './src/components/agent/ItemDetail';
...
<Stack.Screen  name='ItemDetail' options={{ headerShown:false}} component={ItemDetail} />
