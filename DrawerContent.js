              ...
              <View style={styles.userInfoSection}>
                <View style={{flexDirection: 'row', marginTop: 15}}>
                  <Avatar.Image
                    ...
                    style={{marginTop: 5}}
                  />
                  <View style={{marginLeft: 10, flexDirection: 'column'}}>{stateUser!=null?<><Title style={styles.title}>{filterString(stateUser?.firstName)}  {filterString(stateUser?.lastName)}</Title>
